...
<table width='100%' cellspacing='1' cellpadding='2' class="table table-striped table-hover table-condensed  table-bordered" style='table-layout: fixed;overflow: hidden;' bgcolor="#BBDDE5">
    <tbody>
        <tr height="22" bgcolor="#FFFFFF" onMouseOver="this.className='over'" onMouseOut="this.className='out'">
            <td align="center">
                <div align="center">
                    我的收入：<?php echo number_format($userInfo['actual_money'] / 100, 2);?>元（合作者收入：<?php echo number_format($userInfo['partner_money'] / 100, 2);?>元）
                </div>
            </td>
        </tr>
        <br />
        <tr height="22" bgcolor="#FFFFFF" onMouseOver="this.className='over'" onMouseOut="this.className='out'">
            <td align="center">
                <div align="center">
                    引入合作者：<?php echo count($partnerList);?>人
                    <br />
                </div>
            </td>
        </tr>
                ...
                <div align="center">
                    ...
                    if (!empty($partnerList)) {
                        foreach ($partnerList as $partnerItem) {
                            echo sprintf('%s：%s元<br />', $partnerItem['nickname'], number_format($partnerItem['actual_money'] / 100, 2));
                        }
                    }
                    ?>
                </div>
