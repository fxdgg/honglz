...
<?php endif;?>
  ...
  <fieldset>
    ...
    <div class="field" data-api-code="field_<?php echo $field_id;?>">
        <div class="control-group " >
            ...
            <div class="field_content">
                <div class="help-block"><p><?php echo $formConfig[$field_id]['help'];?><?php if (isset($formConfig[$field_id]['must']) && $formConfig[$field_id]['must'] == 1): ?><span style="color:#f00"><strong>*</strong></span><?php endif;?></p></div>
                <div class="controls">
    ...
    <?php endif;?>
    <?php $field_id = 21; if(isset($formConfig[$field_id])):?>
    <div class="field" data-api-code="field_<?php echo $field_id;?>">
        <div class="control-group " >
            <label class="control-label field_title" data-role="collapse_toggle" for="entry_field_<?php echo $field_id;?>"><?php echo $formConfig[$field_id]['name'];?>：</label>
            <div class="field_content">
                <div class="help-block"><p><?php echo $formConfig[$field_id]['help'];?><?php if (isset($formConfig[$field_id]['must']) && $formConfig[$field_id]['must'] == 1): ?><span style="color:#f00"><strong>*</strong></span><?php endif;?></p></div>
                <div class="controls">
                    <input id="entry_field_<?php echo $field_id;?>" name="entry[field_<?php echo $field_id;?>]" type="text" value="" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
                    <span id="msg_<?php echo $field_id;?>" style="color:#f00"></span>
                </div>
            </div>
        </div>
