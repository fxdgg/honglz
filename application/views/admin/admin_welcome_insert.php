...
<script>
    ...
    function change_item(obj, id)
    {
        if(obj.value==0){
            ...
            $('#content_spanid').html("舶来内容");
            $('#welcome_title_divid').html("舶来录入");
            //$('#editor_id').html('');
        }else{
            $('#content_spanid').html("舶来内容");
            $('#welcome_title_divid').html("舶来录入");
...
<body bgcolor="#DDEEF2">
<form action='<?php echo APP_SITE_URL;?>/admin/welcome_insert' method='post'>
<table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#BBDDE5" class="margin_top_10">
  ...
  <tr>
    <td bgcolor="#FFFFFF" height="31" colspan="4">
        <div align="center" class="black_14_bold" id="welcome_title_divid">舶来录入</div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr id="group_div_id_1" bgcolor="#FFFFFF" style="display:none;">
    <td width="15%" align="right" height="25"><b>群福利结束时间：</b></td>
    <td width="35%" colspan="3">
        <input type="text" name="activity_end_time" id="activity_end_time"
            onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})" value="<?php echo $activity_end_time; ?>"
            style="width: 180px; height: 20px;" />
    </td>
  </tr>
  <tr id="group_div_id_2" bgcolor="#FFFFFF" style="display:none;">
  ...
  <tr bgcolor="#FFFFFF">
    <td width="15%" align="right" height="25"><b><span id="content_spanid">舶来内容：</span></b></td>
    <td width="35%" colspan="3">
