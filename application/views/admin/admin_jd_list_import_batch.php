...
<table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#BBDDE5" class="margin_top_10">
  ...
  <tr>
    <td bgcolor="#FFFFFF" height="31" colspan="4">
    	<div align="center" class="black_14_bold">JD列表批量导入(格式：每行一个JD信息，建议每次最多1000个)</div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <!--<td width="15%" align="right" height="25"><b>JD列表：</b><br />(格式：每行一个JD信息，建议每次最多1000个)</td>-->
    <td width="35%"><!-- colspan="3"-->
    	<textarea id="content" name="content" style="width:1100px;height:300px;"></textarea>
    </td>
  </tr>
