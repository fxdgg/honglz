...
<div class="info">
	<div class="infoTop">
		 <h1>关键词-<?php echo $keyword_type;?>列表</h1>
	</div>
</div>
<form method="get" class="form-inline" >
     <div class="search-inline mt10" style="height:auto">
		<em><input id="jdDomain" type="hidden" value="<?php echo APP_SITE_URL;?>" /></em>
        <a href="<?php echo APP_SITE_URL;?>/admin/jd_position_keyword_detail/<?php echo $type;?>">添加关键词</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	...
    	<select name="state" style="width:100px;">
			...
			<option value="new" <?php if (isset($state) && $state=='new'){?> selected <?php }?> >显示</option>
			<option value="delete" <?php if (isset($state) && $state=='delete'){?> selected <?php }?> >隐藏</option>
		</select>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table cellspacing="1" cellpadding="2" width="100%" class="table table-striped table-hover table-condensed  table-bordered" bgcolor="#BBDDE5">
    ...
    <tr height="22" bgcolor="#EEEEEE">
        <th width="3%" align="center"><b>操作</b></th>
        <th width="3%" height="25" align="center"><b>关键词ID</b></th>
        <th width="4%" height="25" align="center"><b>职位名称</b></th>
        <th width="3%" align="center"><b>级别</b></th>
        <th width="6%" align="center"><b>关键词</b></th>
        <th width="3%" align="center"><b>排序</b></th>
        <th width="3%" align="center"><b>状态</b></th>
    </tr>
    </thead>
    <tbody>
    <?php if($jd_keyword_list){foreach ($jd_keyword_list as $data){?>
    <tr id="tr_<?php echo $data['kid'];?>" height="22" bgcolor="#FFFFFF" onMouseOver="this.className='over'" onMouseOut="this.className='out'">
        <td align="center"><a href="<?php echo APP_SITE_URL;?>/admin/jd_position_keyword_detail/<?php echo $type;?>/<?php echo $data['kid'];?>">编辑</a><!--&nbsp;&nbsp;<a href="#" onclick="delPosition(<?php echo $data['kid'];?>);">删除</a>--></td>
