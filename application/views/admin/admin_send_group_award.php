...
<body bgcolor="#DDEEF2">
<form action='<?php echo APP_SITE_URL;?>/admin/send_group_award' method='post'>
<table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#BBDDE5" class="margin_top_10">
  ...
  <tr>
    <td bgcolor="#FFFFFF" height="31" colspan="4">
    	<div align="center" class="black_14_bold">群福利发放</div>
    </td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="15%" align="right" height="25"><b>群福利-舶来帐号：</b></td>
    <td width="35%" colspan="3">
    	...
    	<?php 
    		if (is_array($groupList) && !empty($groupList))
    		{
    			...
    			{
    				echo '<option value="'.$groupItem['id'].'">'.$groupItem['group_title'].'</option>';
    			}
    		}
    	?>
    	</select>
  ...
  <tr bgcolor="#FFFFFF">
    <td width="15%" align="right" height="25"><b>发奖名单：</b><br />(格式：中奖人UID|消息内容)</td>
    <td width="35%" colspan="3">
