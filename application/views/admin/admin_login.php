			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td align="left"><input type="text" name="check_code"
							id="check_code" value="" style="width: 80px;" maxlength="4" /> <img
							src="<?php echo APP_SITE_URL;?>/admin/check_code?time=0" name="check_img"
							id="check_img" title="看不清楚请点击换图" alt="看不清楚请点击换图"
							onclick="flush_check_code();" style="cursor: pointer;" /></td>
					</tr>
					<tr>
						<td height="30" colspan="2">
						<div align="center"><input type="image"
							src="<?php echo IMAGE_PATH;?>login.jpg" name="login" id="login" width="41"
							height="21" onclick="chklogin();" /> &nbsp;&nbsp;<img
