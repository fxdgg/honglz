...
.createBn{width:180px;height:154px;background:url(/bootstrap/img/ScreenLockBut.png) no-repeat;border:none;margin-top:20px;cursor:pointer;}
</style>
...
<form id="userform" name="userform" action='<?php echo APP_SITE_URL;?>/admin/jd_resume_insert' method='post' onSubmit="return submitForm();" >
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="35%" colspan="3" class="inputClass">
            <input type="text" id="subordinate" name="entry[userName]" value="" style="width:500px" />
        </td>
      </tr>
      <tr bgcolor="#FFFFFF">
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td width="35%" colspan="3" class="inputClass">
            <input type="text" id="hopeSalary" name="entry[hopeSalary]" value="" style="width:500px" />
        </td>
      </tr>
      <tr bgcolor="#FFFFFF">
        <td width="15%" align="right" height="25" class="tilte"><b>离职原因：</b></td>
        <td width="35%" colspan="3" class="inputClass">
            <input type="text" id="leaveCause" name="entry[leaveCause]" value="" style="width:500px" />
        </td>
      </tr>
      <tr bgcolor="#FFFFFF">
