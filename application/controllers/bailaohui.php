...
class Bailaohui extends BLH_Controller{
    ...
    */
    private static $union_config = array(
        'unionId' => 1, //社团ID，必填
        'unionName' => '百老汇', //社团名称，必填
        'formScriptName' => 'bailaohui', //跟文件名一致
        'formTitle' => '2015年<{unionName}>年会报名', //表单标题，必填
        'formContent' => '<p>2015年的百老汇年会即将召开，时间是2015年1月25日，地点在工体南门唐廊。餐费AA，每人300元。</p>
        <p>填写该表单报名年会。</p>
        <p>欢迎将本次活动分享给你身边的Exbaiduer！</p>', //表单描述，必填
        ...
        'depart' => array('创始人','VP', '管理者', '高工', '奋斗中'), //现职位，必填
        'submitLocationUrl' => 'http://item.taobao.com/item.htm?spm=0.0.0.0.ErEA1e&id=43086701045', //提交表单后跳转到的链接，默认为空，不跳转
    );
    ...
    {
        BLH_Utilities::redirect(APP_SITE_URL . '/baolaohui/form', 0, true, true, false, true);
    }
    /**
    * 表单展示
    * http://115.28.47.162/hlztest.php/bailaohui/form
    */
    ...
    public function form1()
    {
        ...
        $this->load->view('default/form_show1', $params);
    }
    /**
    * 表单生成
    */
